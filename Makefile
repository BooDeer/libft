...
#    Updated: 2019/11/27 23:26:01 by hboudhir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILESB = ft_lstnew.c ft_lstadd_font.c ft_lstsize.c ft_lstsize.c
OBJB = ft_lstnew.o ft_lstadd_font.o	ft_lstsize.o ft_lstsize.o
all: $(NAME)
